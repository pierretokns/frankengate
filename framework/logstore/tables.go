...
type SearchFilters struct {
	...
	IntegrationUserAgents []string          `json:"integration_user_agents,omitempty"`
...
type Log struct {
	...
	IntegrationUserAgent    *string   `gorm:"type:varchar(255);index:idx_logs_integration_user_agent" json:"integration_user_agent,omitempty"`
