#!/usr/bin/env python3
"""Verify the content-minimized ontology frontier proxy receipt."""
...
def verify(path: Path) -> dict[str, object]:
    ...
    if result.get("schema_version") != "frankengate-ontology-induction-frontier-proxy-v1":
    ...
    if result.get("claim_boundary", {}).get("replay_utility_established") is not False:
        errors.append("replay claim boundary widened")
