...
def build_audit() -> dict[str, Any]:
    ...
    requirements = [
        ...
        },
        {
            ...
            "open_gate": "Natural release lineage is exercised; local Qwen3 4B passed zero of three structural proposal gates while Llama 3.2 passed one of three, demonstrating model-format sensitivity. Semantic task utility and enterprise-labeled concept transfer remain unmeasured.",
        },
        {
