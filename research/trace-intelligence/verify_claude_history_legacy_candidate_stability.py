#!/usr/bin/env python3
"""Verify the content-minimized Claude-history stability receipt."""
...
def verify(input_path: Path, output_path: Path) -> dict[str, object]:
    ...
    checks = {
        ...
        "nonempty_projects": result.get("coverage", {}).get("project_count", 0) > 0,
    }
    receipt = {"schema_version": "frankengate-claude-history-legacy-candidate-stability-verification-v1", "passed": all(checks.values()), "checks": checks, "result_sha256": expected}
