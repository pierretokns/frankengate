...
| Project-held-out lexical adaptation | Full Peter cohort combined prompt+tool MRR `.769341→.854452`; Vaynelee combined MRR stayed `.978495` at ceiling; tool-only Peter MRR slightly declined | Scoped adaptation is testable and sometimes useful, but no universal custom embedding promotion follows |
