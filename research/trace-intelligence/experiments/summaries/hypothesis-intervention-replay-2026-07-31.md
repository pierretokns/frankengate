...
with family-disjoint training (`alpha`) and holdout (`beta`) tasks. The
evidence-derived policy reached 2/3 holdout successes (0.667), while no
proposal and an unrelated placebo reached 0/3.
