...
| Corporate concept/alias discovery | Modernized termhood produced 3,000 candidates; within-schema recall `.358`, held-out transfer `.015`. Acronym probe passed `8/8` synthetic cases with ambiguity abstention. The deterministic train-only alias-enrichment reproduction was identical to the prior receipt: lexical MRR `.734885`, support-1 aliases `.734885`, support-2 aliases `.727542`, with only `.065385` target coverage and 506 ambiguous surfaces. | Candidate mining only; frequency-derived aliases are not yet useful enough for promotion | Reviewed internal aliases, temporal replacements, NILs, same-scope wrong-system labels, and downstream utility. |
