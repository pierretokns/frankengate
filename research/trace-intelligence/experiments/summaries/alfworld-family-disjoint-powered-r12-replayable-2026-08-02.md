...
outcomes and step counts. All 32 rows matched with zero mismatches, and every
replayed action was admissible at the fresh environment state. This closes the
independent task-outcome recomputation gate for this cohort, but it is not a
