...
| `birdsql/bird-interact-full` | Clarification and friction interventions: ambiguity labels, follow-up labels, user simulator, executable tests, and active/passive interaction modes. | Simulator behavior is not natural employee history; no observed skill deficit or independent human outcome. | CC-BY-SA-4.0; evaluator/DB material must remain separated. |
