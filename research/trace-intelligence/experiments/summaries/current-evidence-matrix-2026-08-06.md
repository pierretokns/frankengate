...
| Do mined skills improve agents? | BIRD-SQL trace-mined procedure replay reached `3/20`, equal to no-skill and below a formatting placebo at `4/20`; no skill was promoted. | Require no-skill, placebo, reviewed, generated, and composed controls. | Sequential task chains, outcome-trained consumers, and changed-system evaluation. |
