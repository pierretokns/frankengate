...
| Domain-specific embedding adaptation | Database-family-held-out MATM adapter underperformed deterministic structured scoring and reached 51.2% collision-before-target. Our 601-case, four-family-held-out schema-grounded benchmark also found the regularized adapter below frozen Nomic on MRR/R@1/R@10 (`.1573/.0761/.3214` vs `.1824/.0933/.3760`). | **Negative on public proxy; enterprise recipe still open** | Require SME-labelled undocumented aliases, true NIL/wrong-system cases, entity/time/project holdouts, and downstream changed-system utility lift before promotion. |
