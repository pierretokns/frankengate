...
| Domain-specific embedding adaptation | Database-family-held-out adapter underperformed deterministic structured scoring and reached 51.2% collision-before-target. | **Negative promotion result** | Better labels, larger cohorts, stronger split discipline, and only then another adapter test. |
