...
| Schema-grounded hard negatives automatically improve a domain embedding | A 601-case, four-family-held-out benchmark found frozen Nomic MRR/R@1/R@10 `.1824/.0933/.3760` versus the schema-adaptive pair scorer `.1573/.0761/.3214`; same-scope collision-before-target was `.1013` vs `.1094` | This stronger public-proxy null still does not disprove custom corporate embeddings; it says generated schema labels and a small adapter are insufficient by themselves |
