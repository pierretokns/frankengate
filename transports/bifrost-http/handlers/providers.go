...
func (h *ProviderHandler) RegisterRoutes(r *router.Router, middlewares ...schemas.BifrostHTTPMiddleware) {
	...
	r.GET("/api/v1/agent-model-cards/metadata", lib.ChainMiddlewares(h.getAgentModelCardMetadataV1, middlewares...))
	r.GET("/api/v1/agent-model-cards/versions", lib.ChainMiddlewares(h.getAgentModelCardVersionsV1, middlewares...))
	r.GET("/api/v1/agent-model-cards/diff", lib.ChainMiddlewares(h.getAgentModelCardDiffV1, middlewares...))
	r.GET("/api/v1/agent-model-cards/evidence", lib.ChainMiddlewares(h.getAgentModelCardEvidenceV1, middlewares...))
