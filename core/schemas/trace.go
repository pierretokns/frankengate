...
const (
	...
	// Region pins are intentionally emitted as separate, bounded attributes on
	// key-selection spans.  This makes fail-closed routing diagnosable without
	// exposing credentials or endpoint URLs.
	AttrBifrostRequiredDestinationRegion = "bifrost.routing.required_destination_region"
	AttrBifrostSelectedDestinationRegion = "bifrost.routing.selected_destination_region"
	AttrBifrostDestinationRegionMismatch = "bifrost.routing.destination_region_mismatch"
