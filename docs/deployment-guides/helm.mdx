...
See the full list here: https://github.com/pierretokns/frankengate/tree/dev/helm-charts/bifrost/values-examples
</Note>
...
```bash
# 2. Install
helm install frankengate frankengate/bifrost -f production.yaml
```
...
<Note>
`image.tag` is required - the chart will not start without it. Check the fork-owned [GHCR packages](https://github.com/pierretokns/frankengate/pkgs/container/frankengate) for available versions.
</Note>
...
Enterprise deployments use the fork-owned registry and the governance features
documented in this repository. Availability, support, and compliance claims
are deployment-specific and are not implied by this OSS chart.
...
```bash
helm install frankengate frankengate/bifrost -f enterprise.yaml
```
...
For support, use the FrankenGate repository issue and internal operations
channels associated with your deployment.
...
- [Helm Chart Repository](https://github.com/pierretokns/frankengate/tree/dev/helm-charts)
- [Artifact Hub](https://artifacthub.io/packages/helm/bifrost/bifrost)
- [Example Configurations](https://github.com/pierretokns/frankengate/tree/dev/helm-charts/bifrost/values-examples)
- [GitHub Issues](https://github.com/pierretokns/frankengate/issues)
