...
with bounded exponential backoff; client errors are not retried. SNS/SQS and
in-product delivery should be implemented as consumers of the same event
contract, and are optional integrations rather than mandatory inference
dependencies.
