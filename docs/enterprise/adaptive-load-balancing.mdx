...
| **failover handling Integration** | Temporarily removes poorly performing keys from rotation |
...
- **[failover handling](./failover handling)** - Header-signal-driven failover to a backup provider when a primary endpoint degrades
