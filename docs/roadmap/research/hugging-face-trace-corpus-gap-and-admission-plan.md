...
| [AgentTrace](https://huggingface.co/datasets/pagarsky/agent-trace/tree/4b05b2f00eea267a5bb4d841c228059d1bf9ac0c) | `4b05b2f00eea267a5bb4d841c228059d1bf9ac0c` | Apache-2.0 | 1,400 rows; 32.1 MB repository | **Admit all** | First-class tool timing, exit status, resource telemetry, deterministic NL2Bash fixture | Two small models and narrow MBPP/NL2Bash tasks; no governed identity or DAG |
...
| [CMU Agent Trajectories](https://huggingface.co/datasets/cx-cmu/agent_trajectories/tree/88e2af82c116a9a57f29be6f21b9924da081c2bd) | `88e2af82c116a9a57f29be6f21b9924da081c2bd` | **None declared** | 8,653 retained; approximately 2 GB download shown by the Hub | **Access- and license-quarantine; internal analysis once approved** | Six benchmark strata, five models, four independent passes, external/benchmark rewards, failures and trace metadata | Current authenticated account receives “requires approval”; 1,445 incomplete/crashed/truncated traces were removed; runtime tool menu is not reconstructable |
