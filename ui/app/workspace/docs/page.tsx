...
const docSections = [
	{
		title: "Quick Start",
		description: "Get FrankenGate running in under 30 seconds",
		icon: Play,
		url: "https://github.com/pierretokns/frankengate/tree/dev/docs/quickstart",
		badge: "Popular",
		items: ["HTTP Transport Setup", "Go Package Usage", "Docker Guide"],
	},
	{
		title: "Architecture",
		description: "Deep dive into FrankenGate's design and performance",
		icon: GitBranch,
		url: "https://github.com/pierretokns/frankengate/tree/dev/docs/architecture",
	...
	},
	{
		...
		icon: BookOpen,
		url: "https://github.com/pierretokns/frankengate/tree/dev/docs/usage",
		badge: "Comprehensive",
		items: ["Providers Setup", "Key Management", "Error Handling", "Memory & Networking"],
	},
	{
		title: "Contributing",
		description: "Help improve FrankenGate for everyone",
		icon: Users,
		url: "https://github.com/pierretokns/frankengate/tree/dev/docs/contributing",
	...
	},
	{
		...
		icon: Code,
		url: "https://github.com/pierretokns/frankengate/tree/dev/docs/usage/http-transport/integrations",
	...
	},
	{
		...
		icon: Zap,
		url: "https://github.com/pierretokns/frankengate/blob/dev/docs/benchmarks.md",
...
const featuredDocs = [
	{
		...
		href: "https://github.com/pierretokns/frankengate/blob/dev/docs/mcp.md",
		icon: FileText,
	...
	},
	{
		...
		href: "https://github.com/pierretokns/frankengate/blob/dev/docs/governance.md",
		icon: Shield,
			...
			<div className="mx-auto max-w-7xl">
				<div className="space-y-8">
					...
					<div className="space-y-4 text-center">
						...
						<GradientHeader title="Power Up Your FrankenGate Stack" />
						<p className="text-muted-foreground mx-auto max-w-2xl text-lg">
							Everything you need to know about building production AI applications with FrankenGate
						</p>
						<div className="flex justify-center gap-4">
							<Button asChild>
								<a
					href="https://github.com/pierretokns/frankengate/tree/dev/docs"
									target="_blank"
							...
							<Button variant="outline" asChild>
								<a
					href="https://github.com/pierretokns/frankengate/tree/dev/docs/quickstart"
									target="_blank"
									rel="noopener noreferrer"
