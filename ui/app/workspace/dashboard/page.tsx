	...
	const [urlState, setUrlState] = useQueryStates(
		{
			...
			// Tufte default: time-series comparisons use quiet lines; callers can
			// still opt into bars through the URL state for discrete snapshots.
			volume_chart: parseAsString.withDefault("line"),
			token_chart: parseAsString.withDefault("line"),
			cost_chart: parseAsString.withDefault("line"),
			model_chart: parseAsString.withDefault("line"),
			latency_chart: parseAsString.withDefault("line"),
			cost_model: parseAsString.withDefault("all"),
			usage_model: parseAsString.withDefault("all"),
			provider_cost_chart: parseAsString.withDefault("line"),
			provider_token_chart: parseAsString.withDefault("line"),
			provider_latency_chart: parseAsString.withDefault("line"),
			...
			mcp_volume_chart: parseAsString.withDefault("line"),
			mcp_cost_chart: parseAsString.withDefault("line"),
