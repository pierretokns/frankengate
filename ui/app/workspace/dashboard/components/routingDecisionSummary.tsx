		...
		<section className="rounded-sm border p-3" data-testid="dashboard-routing-decision-summary" aria-label="Routing decisions">
			<div className="mb-2 flex items-center justify-between gap-2">
				<div>
					...
					<p className="text-muted-foreground text-xs">Bounded provider, fallback, and region signals for this team/user scope.</p>
				</div>
			...
			{isLoading ? (
				...
				<div className="grid gap-2 sm:grid-cols-3" data-testid="dashboard-routing-metrics">
